...
namespace PrivateTutorOnline.Controllers
{
    public class ManageCustomersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,FullName,PhoneNumber,Email,City,District,Ward,Street")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,FullName,PhoneNumber,Email,City,District,Ward,Street")] Customer customer)
        {
            if (ModelState.IsValid)
            {
